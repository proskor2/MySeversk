...
package ru.seversknet.MySeversk.ui.mainscreen
...
import ru.seversknet.MySeversk.MapsActivity
import ru.seversknet.MySeversk.R
import ru.seversknet.MySeversk.activities_main.*
import ru.seversknet.MySeversk.pzdc.*
...
//        }
        ...
        button_map.setOnClickListener() {
            val map1 = Intent(this@HomeFragment.context, MapsActivity::class.java)
            startActivity(map1)
        }

        button_alerts.setOnClickListener() {
            val alert1 = Intent(this@HomeFragment.context, alerts::class.java)
            startActivity(alert1)
        }

        button_emergency.setOnClickListener() {
            val remont1 = Intent(this@HomeFragment.context, emergency::class.java)
            startActivity(remont1)
        }
        button_district.setOnClickListener() {
            val distr1 = Intent(this@HomeFragment.context, district::class.java)
            startActivity(distr1)
        }
        button_service.setOnClickListener() {
            val serv1 = Intent(this@HomeFragment.context, remont::class.java)
            startActivity(serv1)
        }
