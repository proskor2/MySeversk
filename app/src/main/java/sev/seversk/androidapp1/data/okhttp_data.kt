package sev.seversk.androidapp1.data

open class okhttp_data() {

//   open fun getJsonData(url: String): String? {
...
// open fun generateDummyList(arrayList: ArrayList) {
//  arrayList = ArrayList<News_data>
//
//  for (i in 0..9) {
